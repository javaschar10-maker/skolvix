...
SUPABASE_KEY = "sb_secret_6kO9Z_7vvqHHDmGzWfU85w_kxhb3dDk"
...
def upload_metadata():
    # Baca file metadata buku
    with open("rag-data/metadata-buku.json", "r", encoding="utf-8") as f:
        metadata_list = json.load(f)

    print(f"📚 Total metadata buku: {len(metadata_list)}")
