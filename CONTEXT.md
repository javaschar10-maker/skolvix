...
- [03-07-2026] app.html & quiz.html: Menambahkan UI Kuis AI premium — form glassmorphism dengan select Kelas dinamis (7-12), select Mapel dinamis berdasarkan kelas (kelas 7-10: Matematika, IPA, IPS, B. Indonesia, B. Inggris, PPKn; kelas 11-12: +Fisika, Kimia, Biologi, Ekonomi, Sejarah, Sosiologi, Geografi), input topik/bab opsional, select jumlah soal (5-15, default 10), input durasi detik (default 60). Timer display di quiz.html (#timerDisplay) dengan styling gold, posisi absolute di #quizCard. CSS glassmorphism untuk .quiz-ai-controls, .ai-form-row, .ai-select, .ai-input dengan mobile responsive <600px.